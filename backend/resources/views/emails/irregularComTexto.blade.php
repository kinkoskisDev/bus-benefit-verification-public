...
<body>
    <div class="email-container">
        ...
        <p style="font-size: 20px;">
            Recebemos suas informações, mas <span style="font-weight: bold;">identificamos um problema com a(s) foto(s) enviada(s)</span>.
        </p>

        @if (!empty($texto_extra))
        ...
        <p style="font-size: 20px;">
            <span style="font-weight: bold;">Pedimos, por gentileza, que responda o questionário novamente e reenvie as fotos corrigidas</span>.
        </p>
